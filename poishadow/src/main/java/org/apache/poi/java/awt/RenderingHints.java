...
import org.apache.poi.sun.awt.SunHints;
        ...
        implements Map<Object,Object>, Cloneable
{
    ...
    public abstract static class Key {
        ...
        private static synchronized void recordIdentity(RenderingHints.Key k) {
            ...
            if (otherref != null) {
                RenderingHints.Key otherkey = (RenderingHints.Key) ((WeakReference) otherref).get();
            ...
            identitymap.put(identity, new WeakReference<RenderingHints.Key>(k));
        }
    ...
    public boolean containsKey(Object key) {
        return hintmap.containsKey((RenderingHints.Key) key);
    }
    ...
    public Object get(Object key) {
        return hintmap.get((RenderingHints.Key) key);
    }
     ...
     *            {@link RenderingHints.Key#isCompatibleValue(java.lang.Object)
    ...
    public Object put(Object key, Object value) {
        if (!((RenderingHints.Key) key).isCompatibleValue(value)) {
            throw new IllegalArgumentException(value+
                    " incompatible with "+
                    key);
        }
        return hintmap.put((RenderingHints.Key) key, value);
    }
    ...
    public Object remove(Object key) {
        return hintmap.remove((RenderingHints.Key) key);
    }
