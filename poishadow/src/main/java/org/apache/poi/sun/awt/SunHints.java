...
public class SunHints {
    ...
    public static class Key extends RenderingHints.Key {
        ...
        public boolean isCompatibleValue(Object val) {
            if (val instanceof SunHints.Value) {
                return ((SunHints.Value)val).isCompatibleKey(this);
            }
            return false;
        }
    }
    ...
    public static class Value {
        ...
        private static SunHints.Value[][] ValueObjects =
                new SunHints.Value[NUM_KEYS][VALS_PER_KEY];

        private static synchronized void register(SunHints.Key key,
                                                  SunHints.Value value) {
    ...
    public static final RenderingHints.Key
            ...
            new SunHints.LCDContrastKey(SunHints.INTKEY_AATEXT_LCD_CONTRAST,
